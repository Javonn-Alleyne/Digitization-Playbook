...
![Preflight Proc 1](../Assets_docs/Images/Green tint .png){ width="550px" data-title="Base Characteristics" data-description=".custom-desc1"}
<figcaption>Base Characteristics</figcaption>
========
![Green Tint](../Assets_docs/Images/Pre_Flight/Green_tint.png){ width="400px" data-title="Green Tint" data-description=".custom-desc1"}
...
<figure markdown>
<<<<<<<< HEAD:DigitizationPlaybook_site_docs/docs/Troubleshoot/troubleshoot.md
![Preflight Proc 1](../Assets_docs/Images/Red Color Cast .jpg){ width="550px" data-title="Base Characteristics" data-description=".custom-desc1"}
<figcaption>Base Characteristics</figcaption>
========
![Preflight Proc 2](../Assets_docs/Images/RedColorCast.jpg){ width="400px" data-title="Red Colour Cast" data-description=".custom-desc2"}
...
<figure markdown>
<<<<<<<< HEAD:DigitizationPlaybook_site_docs/docs/Troubleshoot/troubleshoot.md
![Preflight Proc 1](../Assets_docs/Images/Restart Computer 2 .png){ width="550px" data-title="Base Characteristics" data-description=".custom-desc1"}
<figcaption>Base Characteristics</figcaption>
========
![Preflight Proc 2](../Assets_docs/Images/Restart_Computer_2.png){ width="400px" data-title="Restart Computer" data-description=".custom-desc3"}
